...
def train_baseline(config: Config, data_collator: Collator, 
                                   train_insts: MapStyleJsonDataset, 
                                   dev_insts: MapStyleJsonDataset, 
                                   test_insts: MapStyleJsonDataset):
    """
    train the baseline without denoising
    """
    ...
    train_metrics, dev_metrics, test_metrics, best_dev_f1 = train_one_baseline(config = config, 
...
def train_one_baseline(config: Config, 
